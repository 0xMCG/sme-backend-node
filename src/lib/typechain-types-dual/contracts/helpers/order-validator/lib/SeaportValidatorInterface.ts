...
export interface SeaportValidatorInterfaceInterface extends utils.Interface {
  functions: {
...
export interface SeaportValidatorInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SeaportValidatorInterfaceInterface;
